...
-- now you have yourself a fully dockerized asp.NET Core React App, Yay
16. start coding your Client app and your server
17. if needed: you can add a [heroku postgresDB ](https://www.heroku.com/postgres)
